...
#import "SelectedOptionsAgoCell.h"

#define kReusedCellMark @"kReusedCellMark"
#define kTopViewHeight      28.0f
#define kBottomViewHeight   58.0f

@interface SelectedOptionsAgoView ()<UITableViewDataSource,UITableViewDelegate>
{
...
@property(nonatomic,copy)SelectedOptionsAgoBlock selected;
...
@implementation SelectedOptionsAgoView
...
{
    SelectedOptionsAgoView *optionsView = [SelectedOptionsAgoView createViewFromNib];
...
{
    SelectedOptionsAgoCell * cell = [tableView dequeueReusableCellWithIdentifier:kReusedCellMark];
