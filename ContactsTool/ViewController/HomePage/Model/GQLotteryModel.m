...
#import "GQLotteryModel.h"

@implementation GQLotteryModel

-(NSString *)fullPicUrlString
{
    if (!_fullPicUrlString) {
        _fullPicUrlString = [[DataCenter shareGlobalData].domainUrlString wayStringByAppendingPathComponent:self.pic];
    }
