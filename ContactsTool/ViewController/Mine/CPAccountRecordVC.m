...
- (IBAction)titleButtonAction:(id)sender {
    ...
    [SelectedOptionsAgoView showWithOnView:self.navigationController.view title:@"选择明细类型" options:_typeList selectedIndex:self.selectedType selected:^(NSInteger index) {
...
-(void)queryDataForReferesh
{
    ...
    [GQRequest cookBook_startWithDomainString:[DataCenter shareGlobalData].domainUrlString
                              apiName:GQSerVerAPINameForAPIUserAccountList
