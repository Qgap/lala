...
@interface CookBookBuyCustomConfirmView ()
{
...
@implementation CookBookBuyCustomConfirmView
...
{
    CookBookBuyCustomConfirmView *view = [CookBookBuyCustomConfirmView createViewFromNib];
