...
@interface CBBuyKuaiCConfirmView ()<UITextFieldDelegate>
{
...
@implementation CBBuyKuaiCConfirmView
...
{
    [CBBuyKuaiCConfirmView showFastLotteryConfirmViewOnView:supView lotterys:lotterys numberPeriods:numberPeriods specailType:0 comfirm:confirm];
}
...
+(void)showFastLotteryConfirmViewOnView:(UIView *)supView
                          ...
                          numberPeriods:(NSString *)numberPeriods
                            specailType:(int)specailType
                                comfirm:(CPBuyFastLotteryConfirmAction)confirm
{
    CBBuyKuaiCConfirmView *view = [CBBuyKuaiCConfirmView createViewFromNib];
