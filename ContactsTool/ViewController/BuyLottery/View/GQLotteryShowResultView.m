...
#import "GQLotteryShowResultView.h"
#import "BackgroundCornerLabel.h"
...
@interface GQLotteryShowResultView()
{
...
@implementation GQLotteryShowResultView

static GQLotteryShowResultView *_instance;

+(instancetype)shareInstance
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [GQLotteryShowResultView new];
                            ...
                            isList:(BOOL)isList
{
    ...
    switch (resultType) {
        ...
        default:{
            ...
            NSMutableDictionary *markHeightDictionary = isList? [GQLotteryShowResultView shareInstance].markListViewHeightDictionary : [GQLotteryShowResultView shareInstance].markDetailViewHeightDictionary;
...
-(void)addNormalResultView:(NSArray *)result
{
    ...
    for (int i = 0; i<result.count; i++) {
        ...
        BackgroundCornerLabel *label = [[BackgroundCornerLabel alloc]initWithFrame:CGRectMake(originX, originY, itemWidth, itemWidth) backgroundColor:backgroundColor cornerRadius:itemWidth/2.0f textColor:[UIColor whiteColor] textFont:[UIFont systemFontOfSize:16.0f] text:text];
...
-(void)addPK10ResultView:(NSArray *)result
{
    ...
    for (int i = 0; i<result.count; i++) {
        ...
        BackgroundCornerLabel *label = [[BackgroundCornerLabel alloc]initWithFrame:CGRectMake(originX, originY, itemWidth, itemWidth) backgroundColor:backgroundColor cornerRadius:3.0f textColor:[UIColor whiteColor] textFont:[UIFont systemFontOfSize:16.0f] text:text];
        [self.contentView addSubview:label];
        originX = label.rightX + kItemGap;
    }
}
