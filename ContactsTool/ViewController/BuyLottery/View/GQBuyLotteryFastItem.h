...
@class GQBuyLotteryFastItem;

typedef void(^CPBuyLotteryFastItemClickAction)(NSDictionary *buyInfo, BOOL isSelected);
typedef void(^CPBuyLotteryFastItemClickActionTwo)(GQBuyLotteryFastItem *item, NSDictionary *buyInfo, BOOL isSelected);
typedef void(^CPBuyLotteryFastItemClickActionThree)(NSString *infoIndex, BOOL isSelected);


@interface GQBuyLotteryFastItem : UIView
