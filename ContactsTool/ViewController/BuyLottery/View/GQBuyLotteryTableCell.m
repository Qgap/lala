...
@interface GQBuyLotteryTableCell ()
{
    IBOutlet UIImageView *_pictureImageView;
    IBOutlet UILabel *_titleLabel;
    
    IBOutlet UILabel *_nowLotteryNumberLabel;
    IBOutlet GQLotteryShowResultView *_nowLotteryAnswerView;
...
@implementation GQBuyLotteryTableCell
                         ...
                         cellWidth:(CGFloat)cellWidth;
{
    ...
    height = 50 + [GQLotteryShowResultView resultViewHeightByResult:openResult resultType:CPLotteryResultTypeByTypeString(lotteryModel.type) isWaitOpenResult:lotteryModel.lastOpen.length==0?YES:NO maxWidth:resultViewMaxWidth isList:YES];
    return height;
}
...
{
    NSTimeInterval distance = [_lotteryModel.endTime doubleValue]/1000 -([[NSDate date] timeIntervalSince1970]-[ShiJianManager shareTimeManager].beijingTiemDistance);
