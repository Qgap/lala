...
static DataCenter *shareGlobalData;
...
+(DataCenter *)shareGlobalData{
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        shareGlobalData = [DataCenter new];
...
+(void)cookBook_playButtonClickVoice
{
    ...
    return;
    //播放系统音效
    AudioServicesPlaySystemSound([DataCenter shareGlobalData]->soundFileObject);
